...
var baseHeight : float = 3.5;

var pushDownOffset : float;
...
class CharacterMotorMovement {
	...
	public var maxGroundAcceleration : float = 30.0;
...
private function UpdateFunction () {
	...
	// when walking down a step or over a sharp change in slope.
	 pushDownOffset = Mathf.Max(controller.stepOffset, Vector3(currentMovementOffset.x, 0, currentMovementOffset.z).magnitude);
	if (grounded)
